...
contract nft is Context, ERC165, IERC721Metadata {
    ...
    function collaboratotPercentageOf(
        uint256 tokenId
    ) public view virtual returns (uint256[] memory) {
        uint256[] memory collaboratorPercentage = tokenIdToNFT[tokenId]
            ._collaboratorsPercentage;
